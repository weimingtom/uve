...
#define VERSION_STR1 "Universal Visualnovel Engine"
#define VERSION_STR2 "Copyright (C) 2012-2013 W-Otaku DEV."

#define DEFAULT_SAVE_MENU_NAME "保存档案"
#define DEFAULT_LOAD_MENU_NAME "读取档案"
#define DEFAULT_SAVE_ITEM_NAME "存档"
