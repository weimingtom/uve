...
#else
#define MESSAGE_SAVE_EXIST "%s%s日期%s/%s 时间%s:%s"
#define MESSAGE_SAVE_EMPTY "%s%s-------------------"
#define MESSAGE_SAVE_CONFIRM "是否要存档到%s%s？"
#define MESSAGE_LOAD_CONFIRM "是否从%s%s读取存档？"
#define MESSAGE_RESET_CONFIRM "回到标题画面吗？"
#define MESSAGE_END_CONFIRM "是否要退出？"
